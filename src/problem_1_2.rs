...
impl Problem1_2 {
    pub fn exec(self) {
        ...
        let file_name = format!("problem_1_2, a: {0}, b: {1}, n_x: {2}, n_y: {3}, puasson_coef: {4}, young_modulus: {5}, eps: {6}, function_type: {7}, load_function: {8}", self.a, self.b, self.n_x, self.n_y, self.puasson_coef, self.young_modulus, self.eps, self.function_type, self.load_function);
